...
alias com {
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_3_rsp_mux_001.sv"                              -l altera_common_sv_packages -work rsp_mux_001                              
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_3_rsp_demux_002.sv"                            -l altera_common_sv_packages -work rsp_demux_002                            
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_3_cmd_mux_002.sv"                              -l altera_common_sv_packages -work cmd_mux_002                              
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_3_cmd_demux_001.sv"                            -l altera_common_sv_packages -work cmd_demux_001                            
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_3_router_004.sv"                               -l altera_common_sv_packages -work router_004                               
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                                             -l altera_common_sv_packages -work hps_0_f2h_sdram0_data_agent              
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                                      -l altera_common_sv_packages -work hps_0_f2h_sdram0_data_agent              
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                                        -l altera_common_sv_packages -work hps_0_f2h_sdram0_data_translator         
  ...
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_Finish_signal.v"                                                                            -work Finish_signal                            
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_Data_type.v"                                                                                -work Data_type                                
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L altera_common_sv_packages -L error_adapter_0 -L border -L crosser -L rsp_mux_001 -L rsp_mux -L rsp_demux_002 -L rsp_demux -L cmd_mux_002 -L cmd_mux -L cmd_demux_001 -L cmd_demux -L router_004 -L router_002 -L router_001 -L router -L hps_0_h2f_lw_axi_master_agent -L avalon_st_adapter -L hps_0_f2h_sdram0_data_agent -L hps_0_f2h_sdram0_data_translator -L hps_only_master_master_cmd_width_adapter -L hps_0_f2h_axi_slave_wr_burst_adapter -L alt_vip_vfr_hdmi_avalon_master_limiter -L hps_0_f2h_axi_slave_agent -L alt_vip_vfr_hdmi_avalon_master_agent -L alt_vip_vfr_hdmi_avalon_master_translator -L hps_io -L fpga_interfaces -L p2b_adapter -L b2p_adapter -L transacto -L p2b -L b2p -L fifo -L timing_adt -L jtag_phy_embedded_in_jtag_master -L rst_controller -L irq_mapper_002 -L irq_mapper_001 -L irq_mapper -L mm_interconnect_3 -L mm_interconnect_2 -L mm_interconnect_1 -L mm_interconnect_0 -L sysid_qsys -L mm_bridge_0 -L led_pio -L jtag_uart -L hps_0 -L fpga_only_master -L dipsw_pio -L button_pio -L alt_vip_vfr_hdmi -L alt_vip_itc_0 -L address_span_extender_0 -L ILC -L Finish_signal -L Data_type -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
