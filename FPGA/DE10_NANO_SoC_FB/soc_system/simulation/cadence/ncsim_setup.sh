...
mkdir -p ./libraries/hps_0_f2h_sdram0_data_translator/
...
mkdir -p ./libraries/Finish_signal/
mkdir -p ./libraries/Data_type/
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_3_rsp_mux_001.sv"                              -work rsp_mux_001                               -cdslib ./cds_libs/rsp_mux_001.cds.lib                              
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_3_rsp_demux_002.sv"                            -work rsp_demux_002                             -cdslib ./cds_libs/rsp_demux_002.cds.lib                            
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_3_cmd_mux_002.sv"                              -work cmd_mux_002                               -cdslib ./cds_libs/cmd_mux_002.cds.lib                              
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_3_cmd_demux_001.sv"                            -work cmd_demux_001                             -cdslib ./cds_libs/cmd_demux_001.cds.lib                            
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_3_router_004.sv"                               -work router_004                                -cdslib ./cds_libs/router_004.cds.lib                               
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                                             -work hps_0_f2h_sdram0_data_agent               -cdslib ./cds_libs/hps_0_f2h_sdram0_data_agent.cds.lib              
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                                      -work hps_0_f2h_sdram0_data_agent               -cdslib ./cds_libs/hps_0_f2h_sdram0_data_agent.cds.lib              
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                                        -work hps_0_f2h_sdram0_data_translator          -cdslib ./cds_libs/hps_0_f2h_sdram0_data_translator.cds.lib         
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_Finish_signal.v"                                               -work Finish_signal                             -cdslib ./cds_libs/Finish_signal.cds.lib                            
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_Data_type.v"                                                   -work Data_type                                 -cdslib ./cds_libs/Data_type.cds.lib                                
