	soc_system u0 (
		...
		.data_type_external_connection_export      (<connected-to-data_type_external_connection_export>),      //     data_type_external_connection.export
		...
		.finish_signal_external_connection_export  (<connected-to-finish_signal_external_connection_export>),  // finish_signal_external_connection.export
		...
		.input_addr_external_connection_export     (<connected-to-input_addr_external_connection_export>),     //    input_addr_external_connection.export
		...
		.output_addr_external_connection_export    (<connected-to-output_addr_external_connection_export>),    //   output_addr_external_connection.export
		.ping_ram_address                          (<connected-to-ping_ram_address>),                          //                          ping_ram.address
		.ping_ram_read                             (<connected-to-ping_ram_read>),                             //                                  .read
		.ping_ram_readdata                         (<connected-to-ping_ram_readdata>),                         //                                  .readdata
		.ping_ram_write                            (<connected-to-ping_ram_write>),                            //                                  .write
		.ping_ram_writedata                        (<connected-to-ping_ram_writedata>),                        //                                  .writedata
		.ping_ram_readdatavalid                    (<connected-to-ping_ram_readdatavalid>),                    //                                  .readdatavalid
		.ping_ram_waitrequest                      (<connected-to-ping_ram_waitrequest>),                      //                                  .waitrequest
		.ping_ram_byteenable                       (<connected-to-ping_ram_byteenable>),                       //                                  .byteenable
		.ping_ram_burstcount                       (<connected-to-ping_ram_burstcount>),                       //                                  .burstcount
		.reset_reset_n                             (<connected-to-reset_reset_n>),                             //                             reset.reset_n
		.weight_addr_external_connection_export    (<connected-to-weight_addr_external_connection_export>)     //   weight_addr_external_connection.export
	);
